...
class Classic{
  public:
    ...
    Classic(int rows, int columns, float density); // overloaded constructor for random grid
    Classic(char** grid, int rows, int columns); // overloaded constructor for provided file
    ~Classic(); // destructor
